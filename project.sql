...
user_id INT,
stock_id INT,
constraint fk_user1 FOREIGN KEY (user_id) REFERENCES Users(user_id) on update cascade on delete cascade,
constraint fk_stock1 FOREIGN KEY (stock_id) REFERENCES Stocks(stock_id) on update cascade on delete cascade,
price numeric(10,2) NOT NULL,
volume numeric(10) DEFAULT'1'
);
...
user_id INT,
stock_id INT,
constraint fk_user2 FOREIGN KEY (user_id) REFERENCES Users(user_id) on update cascade on delete cascade,
constraint fk_stock2 FOREIGN KEY (stock_id) REFERENCES Stocks(stock_id) on update cascade on delete cascade,
price numeric(10,2) NOT NULL,
volume numeric(10) DEFAULT'1'
);
